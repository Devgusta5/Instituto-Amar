      ...
      <div className="container-custom">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 mb-12">
          {donationPlans.map((plan, index) => (
            <div
              key={plan.id}
              className={`relative bg-white text-gray-900 rounded-2xl p-8 shadow-2xl flex flex-col items-center justify-between h-full min-h-[420px] transition-all duration-300 hover:scale-105 animate-scale-in w-full`}
            ...
            >
              ...
              <ul className="space-y-3 mb-8 flex-1 flex flex-col justify-center">
