        ...
        <div className="container-custom">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl md:text-2xl text-green-100 leading-relaxed">
              Estamos aqui para ouvir você. Entre em contato conosco para tirar dúvidas, fazer sugestões ou se tornar
              um voluntário.
            </p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            {contactInfo.map((info, index) => (
              <div key={index} className="text-center p-6 bg-gray-50 rounded-2xl hover:shadow-lg transition-shadow">
                <div className={`${info.color} bg-gray-100 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4`}>
